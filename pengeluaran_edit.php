      ...
      <div id="content">
       ...
       <?php include "layout/header.php" ?>
        ...
        <div class="container-fluid">
        	<h3 class="m-0 font-weight-bold text-primary">Edit Data Pengeluaran</h3>
         <div class="card shadow mb-4">
            ...
            ?>
				...
				<form action="proses/pengeluaran_edit_aksi.php" method="post">
				...
				<div class="form-group">
					...
					<select name="id_kategori" class="form-control">
						<option>.....</option>
						<?php
			            	$res=mysqli_query($connect,"SELECT * FROM tbl_kategori  where kat_trans = 'Pengeluaran' ORDER BY id_kategori ") or die(mysqli_error());
				...
				<div class="form-group">
					<label>Debit</label>
					<input type="number" name="debit" required="required" class="form-control" value="<?php echo $p['debit']?>">
				</div>
				<div class="form-group">
