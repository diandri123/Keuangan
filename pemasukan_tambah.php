      ...
      <div id="content">
       ...
       <?php include "layout/header.php" ?>
        ...
        <div class="container-fluid">
        	<h3 class="m-0 font-weight-bold text-primary">Tambah Data Pemasukan</h3>
         <div class="card shadow mb-4">
            <div class="card-body">
			<a href="pemasukan.php" class="btn btn-primary btn-sm ">Kembali</a><br><br>

				<form action="proses/pemasukan_tambah_aksi.php" method="post">
				...
				<div class="form-group">
					<label>Kredit</label>
					<input type="number" name="kredit" required="required" class="form-control" >
				</div>
				<div class="form-group">
