          ...
          <div class="card-body p-0">
            <div class="p-4">
                  <div class="text-center">
                    <img src="assets/img/logogci.png">
                  ...
                  <form class="user" method="post" action="proses/login.php">
                    <div class="form-group" >
                      <input type="email" class="form-control form-control-user" id="exampleInputEmail" name="username" placeholder="Enter Email Address...">
                    </div>
                    <div class="form-group">
